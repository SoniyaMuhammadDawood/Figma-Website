...
<div className="mb-12 flex flex-col items-center">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="mt-4 mb-2">
                <span className="font-medium">Nike Members</span> can store multiple debit or credit cards in their profile for faster checkout. If youre not already a Member
                <span className="text-gray-600">join us today</span>.
              </p>
  ...
  <div className="space-y-4">
    ...
    <div>
      ...
      <p className="text-sm">No payment for Nike orders cant be split between multiple payment methods.</p>
    </div>
    <div>
