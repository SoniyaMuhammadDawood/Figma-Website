...
<div className="mb-12 flex flex-col items-center">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="mt-4 mb-2">
                <span className="font-medium underline">Nike Members</span> can store multiple debit or credit cards in their profile for faster checkout. If youre not already a Member 
  ...
  <div className="space-y-4">
    <div>
      <h3 className="font-bold mb-1">Does my card need international purchases enabled?</h3>
    ...
    <div>
    <p className="text-md">
        Please note some banks may charge <span className='underline'>a small transaction fee </span> for international orders.
      </p>
    </div>

    <div>
      <h3 className="font-bold mb-1">Can I pay for my order with multiple methods?</h3>
      <p className="text-md">No payment for Nike orders cant be split between multiple payment methods.</p>
    </div>
    <div>
      <h3 className="font-bold mb-1">What payment method is accepted for SNKRS orders?</h3>
      <p className="text-md">You can use any accepted credit card to pay for your SNKRS order.</p>
    </div>
    <div>
      <h3 className="font-bold mb-1">Why dont I see Apple Pay as an option?</h3>
      <p className="text-md">
        To see Apple Pay as an option in the Nike App or on Nike.com youll need to use a compatible Apple device running the latest OS be signed in to your iCloud account and have a supported card in your Wallet. Additionally youll need to use Safari to use Apple Pay on Nike.com.
      </p>
    </div>
  </div>
  <div className="mt-6">
      ...
      <p className="text-sm font-bold">RELATED</p>
            ...
            <section>
              ...
              <ul className="space-y-2 font-bold">
                <li>
                  <a href="#" className="underline">WHAT ARE NIKES DELIVERY OPTIONS?</a>
                </li>
                <li>
                  <a href="#" className="underline">HOW DO I GET FREE DELIVERY ON NIKE ORDERS?</a>
                </li>
              </ul>
            </section>
          </div>
  ...
  <section>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">Products & Orders: 24 hours a day</p>
